...
class PropertyInspector extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (selectedLayer == null) {
      return _buildEmptyState(state.template.canvasSpec, notifier);
    }
  ...
  Widget _buildEmptyState(dynamic spec, EditorNotifier notifier) {
    return Container(
      color: AppColors.panelBackground,
      ...
      child: Column(
        ...
        children: [
          const Icon(Icons.touch_app_outlined, color: AppColors.textMuted, size: 36),
          ...
          const Text(
            'Select a layer on the canvas or layers panel to edit properties.',
