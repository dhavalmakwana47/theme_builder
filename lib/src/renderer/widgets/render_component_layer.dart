      ...
      default:
        return Container(
          ...
          child: Center(
            child: Text(
              layer.name,
              style: TextStyle(color: Color(style.textColorHex), fontSize: style.fontSize),
            ),
          ),
        );
    }
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Text(team, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 13)),
            const Spacer(),
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(kills, style: const TextStyle(color: Color(0xFF9CA3AF), fontSize: 11)),
              ],
            ),
          ],
        ),
    ...
    return SizedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: const Border(bottom: BorderSide(color: Color(0xFF3B82F6), width: 2)),
        ),
        child: Row(
